...
Before starting to send data to Kafka, we need to generate PEM files in order for Python to connect securely to the Kafka cluster deployed on OpenShift; a couple of convenient scripts are provided to do the job:
